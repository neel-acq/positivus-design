...
export default function Footer() {
  return (
    <>
      <footer className="hidden lg:block bg-black h-128 rounded-t-[48px] mt-35">
                    ...
                    <div className="p-6">
                      <form className="flex flex-col sm:flex-row gap-4">
                        ...
                        <Button
                          ...
                          type="submit"
                          className="bg-[#B9FF66] px-4 py-2 rounded-md hover:bg-[#B9FF66] transition-colors border-none"
                        >
                          Subscribe to news
                        </Button>
                      </form>
